...
public class ImagesType extends BaseEntity implements Serializable {
    ...
    @OneToMany(mappedBy = "refImageType", fetch = FetchType.LAZY)
    private Collection<Images> imagesCollection;

    public ImagesType() {
    }

    public ImagesType(Long tid) {
        this.tid = tid;
    }

    public ImagesType(Long tid, String name) {
        this.tid = tid;
        this.name = name;
    }
    ...
    public boolean equals(Object object) {
        ...
        ImagesType other = (ImagesType) object;
